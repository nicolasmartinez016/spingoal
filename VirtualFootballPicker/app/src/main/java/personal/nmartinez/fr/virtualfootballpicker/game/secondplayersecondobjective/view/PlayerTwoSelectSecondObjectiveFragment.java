package personal.nmartinez.fr.virtualfootballpicker.game.secondplayersecondobjective.view;
...
import personal.nmartinez.fr.virtualfootballpicker.game.secondplayersecondobjective.presenter.SecondPlayerSecondObjectiveView;
import personal.nmartinez.fr.virtualfootballpicker.game.secondplayersecondobjective.presenter.SecondPlayerSecondObjectivePresenterImpl;
...
public class PlayerTwoSelectSecondObjectiveFragment extends Fragment implements SecondPlayerSecondObjectiveView {
    ...
    @BindView(R.id.second_player_second_period_objective_textview) TextView objectiveTextView;
    @BindView(R.id.pick_second_player_second_objective_button) ImageView selectObjectiveButton;
    @BindView(R.id.iv_second_player_second_objective_hat) ImageView hatImageView;
    @BindView(R.id.second_player_second_objective_next_button) TextView nextButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_player_two_select_second_objective, container, false);
