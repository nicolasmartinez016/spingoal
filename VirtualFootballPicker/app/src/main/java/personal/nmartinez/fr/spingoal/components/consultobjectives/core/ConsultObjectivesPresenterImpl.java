package personal.nmartinez.fr.spingoal.components.consultobjectives.core;

import android.content.Context;

import personal.nmartinez.fr.spingoal.components.consultobjectives.view.ConsultObjectivesView;
