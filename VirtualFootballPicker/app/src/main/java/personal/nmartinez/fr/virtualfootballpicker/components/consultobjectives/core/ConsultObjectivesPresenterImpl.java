package personal.nmartinez.fr.virtualfootballpicker.components.consultobjectives.core;

import android.content.Context;

import personal.nmartinez.fr.virtualfootballpicker.components.consultobjectives.view.ConsultObjectivesView;
